...
the **Data** folder and it is a standard input fileㄩ
``` 
100
17,18,18
...
Line 9: Number of subloops:
        64
Line 10: Coefficient used to calculate time step size (typically ranges from 0.4 to 0.8)ㄩ
        0.7
Line 11: Number of model subareas:
        3
Line 12: Subarea 1. Cells range (x=1每17,y=1每18,z=1每18) and conductivity (0.1 S/m) of the background: 
        1,17,1,18,1,18,0.1
Line 13: Subarea 2, Cells range (x=1每17,y=1每18,z=1每9) and conductivity (0.0003 S/m) of the air:
        1,17,1,18,1,9,0.0003
Line 14: Subarea 3, Cells range (x=7每11,y=11每12,z=12每13) and conductivity (2 S/m) of the conductive brick:
        7,11,11,12,12,13,2
```
### 2. Run the program.
